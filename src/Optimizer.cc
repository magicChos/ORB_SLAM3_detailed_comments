...
namespace ORB_SLAM3
{
    ...
    void Optimizer::LocalBundleAdjustment(KeyFrame *pKF, bool *pbStopFlag, vector<KeyFrame *> &vpNonEnoughOptKFs)
    {
        ...
        // 一级、二级相邻定义https://img-blog.csdnimg.cn/244d22d5cf1f41c5ba5edd7b7ad2bdc5.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L1dhbGtpbmdfcm9sbA==,size_16,color_FFFFFF,t_70
